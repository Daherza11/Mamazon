...
<body>
	...
	<div class="carritob">
		...
		<br>
		<span>Monto Total: <b class="text-green">$<?=number_format($monto_total)?> <?=$divisa?></b></span>
		...
		<small>Para más detalles ir a <a href="?p=carrito">Mi Carrito</a>.</small>
	</div>
	<?php
			}
		?>
	<div class="footer">
		Copyright Equipo 7 &copy; <?=date("Y")?>
	</div>
</body>
</html>
