...
if(isset($cat)){
	...
	?>
	<h1>Categoría filtrada por: <?=$rc['categoria']?></h1>
	<?php
}
...
if(isset($agregar) && isset($cant)){
	...
	alert("Se ha agregado al carrito de compras.",1,'ofertas');
	//redir("?p=ofertas");
}
...
<h1>Ofertas</h1><br>
	<form method="post" action="">
		<div class="row">
			...
			<div class="col-md-2">
				<button style="color:white; background: #ff8800;" type="submit" class="btn btn-warning" name="buscar"><i class="fa fa-search"></i> Buscar</button>
			</div>
		</div>
	</form>
	<br>
